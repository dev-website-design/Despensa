// =====================================================
// app.js - Corregido: Sistema global de confirmación de compra
// =====================================================
...
// ==========================================
// LÓGICA UNIFICADA DE COMPRA Y CARRITO
// ==========================================
...
// 🛠️ CORRECCIÓN PRINCIPAL: Escucha global de eventos para los botones de confirmación
document.addEventListener('click', function(e) {
    if (e.target.id === 'btn-confirm-purchase-frutas' && fvCurrentProduct) {
        console.log("✅ Confirmando compra en Frutas");
        agregarAlCarrito('frutas', fvCurrentProduct, fvCurrentQuantity);
    } else if (e.target.id === 'btn-confirm-purchase-cocina' && cocinaCurrentProduct) {
        console.log("✅ Confirmando compra en Cocina");
        agregarAlCarrito('cocina', cocinaCurrentProduct, cocinaCurrentQuantity);
    } else if (e.target.id === 'btn-confirm-purchase-salon' && salonCurrentProduct) {
        console.log("✅ Confirmando compra en Salón");
        agregarAlCarrito('salon', salonCurrentProduct, salonCurrentQuantity);
    }
});
...
// Añadir Fruta (Mismo código funcional que el resto)
...
console.log('✅ App cargada. ¡Sistema de compra corregido al 100%!');